...
<title>調酒師的評分明細</title>

<?php

if($_SESSION['username'] =="admin" ){ //管理員登入的話 回到管理員首頁 
    echo "<a href='member.php'>管理員首頁<a><br>";
}

else if($_SESSION['username'] !="admin"){//調酒師登入的話 回到調酒師首頁 
    echo "<a href='advanced_user.php'>會員首頁<a><br>";
